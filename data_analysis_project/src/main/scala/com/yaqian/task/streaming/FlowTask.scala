package com.yaqian.task.streaming

import com.yaqian.bean.domain.dimension.{DateDimension, LocationDimension}
import com.yaqian.bean.{IPRule, StatsLocationFlow}
import com.yaqian.common.AnalysisLog
import com.yaqian.config.ConfigurationManager
import com.yaqian.constants.{GlobalConstants, LogConstants}
import com.yaqian.dao.{DimensionDao, StatsLocationFlowDao}
import com.yaqian.enum.EventEnum
import com.yaqian.jdbc.JdbcHelper
import com.yaqian.kafka.KafkaManager
